...
<body>
    ...
    <p>
        ...
        * 동기식 / 비동기식<br>
          ...
          <ul>
            ...
            <li>서버에 요청한 결과까지의 시간이 지연되면 무작정 계속 기다려야 됨(흰 페이지로 보여짐)</li>
          ...
          * 비동기식의 단점<br>
          - 현재 페이지에 지속적으로 리소스가 쌓임
          - 에러 발생시 디버깅 어려움<br>
          - 요청 처리 후에 돌아온 응답데이터를 가지고 현재페이지에 새로운 요소를 만들어서 보여줘야<br>
   ...
   <!--	  버튼을 클릭하면 id 체크하기 
    ...
    <script type="text/javascript">
    	$(() => {
    		...
    		$.ajax({
    			...
    			error : function() {
    				console.log("아이디 중복 체크용 ajax통신실패");
    			}
    		})
    	})
    })
    ...
    <form action="idCheck.me" id="enrollForm">
